...
parser.add_argument('--data_path', type=str, default='/mnt/code/data/data_source_A.csv', help='Path to the input data. Only used during local testing. Flow triggered jobs will use task inputs.')
